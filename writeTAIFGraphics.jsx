...
//denna info ska läsas in från fil    
    
    var awayTeamShort = "SKÖ"; 
    var awayLogo = "Logga, Skövde";
    var awayTeamName = "Skövde";
    
    var headline = "Omgång 2"; 
    var matchDate = "2015-09-02";
    var periods = 3 // testar med en period först
    var result = "4-5";
    
        // mängd mål styrs av goal arrayen
    
    var period1_goal_time = new Array("02:34", "05:22", "15:43");
    var period1_goal_teamStat = new Array("EQ", "EQ", "PP1");
    var period1_goal= new Array();  // testar med inga mål. Verkar funka. 
   ...
   var period2_goal_time = new Array("02:42", "05:22", "15:43");
    var period2_goal_teamStat = new Array("EQ", "EQ", "PP1");
    var period2_goal= new Array("1-0", "1-4", "2-1");  // testar både hemma och borta mål
    var period2_goal_team = new Array("h", "b", "h");
    var period2_scorer = new Array("5 Albin Torstensson", "12 adam lind", "14 kalle anka"); // 3 mål,. fösta ska identifieras av bild, andra är borta lag, tredje, dummy spelare
    var period2_ass1 = new Array("12 kalle ank", "22 brumsibums", "N/A"); // 1ass på första 2, sedan inte
    var period2_ass2 = new Array("22 braj", "12 fasdf", "N/A"); // 2 ass på första, sedan inga

   var period3_goal_time = new Array("02:34", "05:22", "12:43");
    var period3_goal_teamStat = new Array("SH1", "EQ", "PP1");
    var period3_goal= new Array("4-0", "1-1", "2-1");  // testar både hemma och borta mål
    var period3_goal_team = new Array('h', 'b', 'h');
    var period3_scorer = new Array("5 Albin Torstensson", "12 adam lind", "14 kalle anka"); // 3 mål,. fösta ska identifieras av bild, andra är borta lag, tredje, dummy spelare
    var period3_ass1 = new Array("12 kalle ank", "22 fdaf", "N/A"); // 1ass på första 2, sedan inte
    var period3_ass2 = new Array("22 braj", "N/A", "N/A"); // 2 ass på första, sedan inga
...
//denna info ska läsas in från fil    
    ...
    // Consts  
    var scriptPath = "F:/TAIF/Scripttest/";
    ...
    function writeGoalsForPeriod(period) {
        ...
        for (var goalIdx = 0; goalIdx < period_goal.length; goalIdx++) {   
            ...
            if (doesLayerExistUndergroup(mainLayer["Spelarbilder"],period_scorer[goalIdx]) && period_goal_team[goalIdx]== "h") {
                ...
                layer=mainLayer["Spelarbilder"].artLayers["0. Dummy"];
                doc.activeLayer = layer;        
  ...
  function writeGoalSummaryForPeriod(period) {
        if (period == 0) {
           ...
           // show correct away team logo
            // make sure all other layers are hidden berfore using this
            layer=mainLayer["Loggor, höger"].artLayers[awayLogo];  
            doc.activeLayer = layer;
            layer.visble = 1; 
